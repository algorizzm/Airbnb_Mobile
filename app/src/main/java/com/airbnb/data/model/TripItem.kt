...
data class TripItem(
    ...
    fun isCompleted(): Boolean = reservation.status.equals("completed", ignoreCase = true)

    /** Returns true if this trip is cancelled. */
    fun isCancelled(): Boolean = reservation.status.equals("cancelled", ignoreCase = true)
