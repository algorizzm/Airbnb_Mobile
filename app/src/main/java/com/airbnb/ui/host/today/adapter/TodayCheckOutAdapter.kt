...
import com.airbnb.databinding.ItemTodayCheckoutBinding
import com.airbnb.utils.formatting.DateFormatter
import com.bumptech.glide.Glide

/**
 * Adapter for displaying today's check-outs.
 */
class TodayCheckOutAdapter(
    private val onItemClick: (Reservation) -> Unit
) : ListAdapter<Reservation, TodayCheckOutAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemTodayCheckoutBinding.inflate(
    ...
    class ViewHolder(
        private val binding: ItemTodayCheckoutBinding,
        private val onItemClick: (Reservation) -> Unit
        ...
        fun bind(reservation: Reservation) {
            binding.apply {
                ...
                // Check-out message
                tvCheckOutMessage.text = DateFormatter.formatCheckOutMessage(
